<!---footer--->
			...
			<div class="container">
				<div class="footer-grids">
					<div class="col-md-3 footer-grid">
						<h4>Tuấn Đạt Shop </h4>
						<p>Tuấn Đạt chuyên cung cấp áo sơ mi nam nhã nhặn uy tín cho quý khách.</p>
					...
					<div class="col-md-3 footer-grid">
						...
						<ul>
                            <?php 
                                ...
                                {
                             ?>
                                <li><a href="user.php" style="color: #eeff0b;">Chào mừng: <?php echo $_COOKIE["userName"] ?></a></li>
					...
					<div class="col-md-3 footer-grid foot">
						<h4>Liên hệ</h4>
						<ul>
							<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i><a href="#">120, Tôn Đức Thắng, TP. Đà Nẵng</a></li>
							<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i><a href="#">0123-456-789</a></li>
							<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:tuandat@mail.com"> tuandat@gmail.com</a></li>
		...
		<div class="copy-section">
			<div class="container">
				<div class="copy-left">
					<p>&copy; 2016 Tuấn Anh Shop . Áo sơ mi nam | Design by <a href="http://congbkhit.com">congbkhit</a></p>
				</div>
